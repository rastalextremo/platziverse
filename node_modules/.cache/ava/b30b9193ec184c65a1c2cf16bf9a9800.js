...
test.serial('Metric#create', async t => {
  ...
  t.true(_rec4._expr(_rec4._capt(_rec4._capt(_rec4._capt(AgentStub, 'arguments/0/callee/object/object').findOne, 'arguments/0/callee/object').calledWidth(_rec4._capt(uuidArgs, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(AgentStub.findOne.calledWidth(uuidArgs), \'Funcion findOne esta siento llamada con parametros\')',
    filepath: 'tests/metric_test.js',
    line: 73,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"AgentStub","range":[7,16]},"property":{"type":"Identifier","name":"findOne","range":[17,24]},"computed":false,"range":[7,24]},"property":{"type":"Identifier","name":"calledWidth","range":[25,36]},"computed":false,"range":[7,36]},"arguments":[{"type":"Identifier","name":"uuidArgs","range":[37,45]}],"range":[7,46]},{"type":"StringLiteral","value":"Funcion findOne esta siento llamada con parametros","range":[48,100]}],"range":[0,101]}',
