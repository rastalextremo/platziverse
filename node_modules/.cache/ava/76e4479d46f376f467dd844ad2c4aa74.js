...
test.serial('Agent#byId', async t => {
  ...
  t.true(_rec6._expr(_rec6._capt(_rec6._capt(_rec6._capt(AgentStub, 'arguments/0/object/object').byId, 'arguments/0/object').called, 'arguments/0'), {
    content: 't.true(AgentStub.byId.called, \'Funcion byId esta siendo llamada\')',
    filepath: 'tests/agent-tests.js',
    line: 73,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"AgentStub","range":[7,16]},"property":{"type":"Identifier","name":"byId","range":[17,21]},"computed":false,"range":[7,21]},"property":{"type":"Identifier","name":"called","range":[22,28]},"computed":false,"range":[7,28]},{"type":"StringLiteral","value":"Funcion byId esta siendo llamada","range":[30,64]}],"range":[0,65]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"AgentStub","range":[7,16]},{"type":{"label":"."},"range":[16,17]},{"type":{"label":"name"},"value":"byId","range":[17,21]},{"type":{"label":"."},"range":[21,22]},{"type":{"label":"name"},"value":"called","range":[22,28]},{"type":{"label":","},"range":[28,29]},{"type":{"label":"string"},"value":"Funcion byId esta siendo llamada","range":[30,64]},{"type":{"label":")"},"range":[64,65]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'Funcion byId esta siendo llamada');
  t.true(_rec7._expr(_rec7._capt(_rec7._capt(_rec7._capt(AgentStub, 'arguments/0/object/object').byId, 'arguments/0/object').calledOnce, 'arguments/0'), {
    content: 't.true(AgentStub.byId.calledOnce, \'Funcion byId esta siendo llamada una sola vez\')',
    filepath: 'tests/agent-tests.js',
    line: 74,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"AgentStub","range":[7,16]},"property":{"type":"Identifier","name":"byId","range":[17,21]},"computed":false,"range":[7,21]},"property":{"type":"Identifier","name":"calledOnce","range":[22,32]},"computed":false,"range":[7,32]},{"type":"StringLiteral","value":"Funcion byId esta siendo llamada una sola vez","range":[34,81]}],"range":[0,82]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"AgentStub","range":[7,16]},{"type":{"label":"."},"range":[16,17]},{"type":{"label":"name"},"value":"byId","range":[17,21]},{"type":{"label":"."},"range":[21,22]},{"type":{"label":"name"},"value":"calledOnce","range":[22,32]},{"type":{"label":","},"range":[32,33]},{"type":{"label":"string"},"value":"Funcion byId esta siendo llamada una sola vez","range":[34,81]},{"type":{"label":")"},"range":[81,82]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'Funcion byId esta siendo llamada una sola vez');
  t.true(_rec8._expr(_rec8._capt(_rec8._capt(_rec8._capt(AgentStub, 'arguments/0/callee/object/object').byId, 'arguments/0/callee/object').calledWith(_rec8._capt(id, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(AgentStub.byId.calledWith(id), \'Funcion byId esta siendo llamada con un id de argumento\')',
    filepath: 'tests/agent-tests.js',
    line: 75,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"AgentStub","range":[7,16]},"property":{"type":"Identifier","name":"byId","range":[17,21]},"computed":false,"range":[7,21]},"property":{"type":"Identifier","name":"calledWith","range":[22,32]},"computed":false,"range":[7,32]},"arguments":[{"type":"Identifier","name":"id","range":[33,35]}],"range":[7,36]},{"type":"StringLiteral","value":"Funcion byId esta siendo llamada con un id de argumento","range":[38,95]}],"range":[0,96]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"AgentStub","range":[7,16]},{"type":{"label":"."},"range":[16,17]},{"type":{"label":"name"},"value":"byId","range":[17,21]},{"type":{"label":"."},"range":[21,22]},{"type":{"label":"name"},"value":"calledWith","range":[22,32]},{"type":{"label":"("},"range":[32,33]},{"type":{"label":"name"},"value":"id","range":[33,35]},{"type":{"label":")"},"range":[35,36]},{"type":{"label":","},"range":[36,37]},{"type":{"label":"string"},"value":"Funcion byId esta siendo llamada con un id de argumento","range":[38,95]},{"type":{"label":")"},"range":[95,96]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'Funcion byId esta siendo llamada con un id de argumento');
...
//# sourceMappingURL=/home/sistemas/Documentos/Cursos/NodeJs/platziverse/node_modules/.cache/ava/76e4479d46f376f467dd844ad2c4aa74.js.map